...
namespace BookStore
{
    ...
    public class Program
    {
        ...
        private static void Add(string parameters)
        {
            ...
            {
                Console.WriteLine(ex.Message);
                Logger.Error(ex, "Unable to add book to store - such book already exists. ISBN - {0}", isbn);
            }
        }
        ...
        private static void Remove(string parameters)
        {
            ...
            {
                Console.WriteLine(ex.Message);
                Logger.Error(ex, "Unable to remove book from store - there is no book with ISBN = {0}", isbn);
            }
        }
