...
namespace BookStore
{
    ...
    public class BookListService
    {
        ...
        {
            this.OpenDefault();
            Logger.Info("Service started succesfully. List contains {0} record(s)", this.list.Count);
        }
        ...
        public void Open(string path)
        {
            ...
            {
                Logger.Error(ex, "Failed to open file using path: {0}", path);
        ...
        public void Write(string path)
        {
            ...
            {
                Logger.Error(ex, "Failed to write to file using path: {0}", path);
                this.OnOutput(this, new BookServiceEventArgs(ex.Message));
            }
        }
