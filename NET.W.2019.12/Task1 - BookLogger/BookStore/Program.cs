...
namespace BookStore
{
    ...
    public class Program
    {
        ...
        private static BookListService booklistService = new BookListService(Logger);
        ...
        private static void Remove(string parameters)
        {
            ...
            {
                Console.WriteLine(ex.Message);
                Logger.Error(ex, $"Unable to remove book from store - there is no book with ISBN = {isbn}");
            }
        }
