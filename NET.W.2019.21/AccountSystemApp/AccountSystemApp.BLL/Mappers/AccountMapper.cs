...
namespace AccountSystemApp.BLL.Mappers
{
    ...
    public static class AccountMapper
    {
        ...
        public static Account ToAccount(this AccountDTO accountDTO)
        {
            ...
            Account newAccount = CreateAccount(enumType, accountDTO.AccountOwner, accountDTO.AccountSum, accountDTO.BonusScore);
            newAccount.AccountNumber = accountDTO.AccountDTOId;
        ...
        /// </returns>
        internal static Account CreateAccount(AccountType enumType, string accountOwner, decimal accountSum, int bonusScore)
        {
            ...
            Account newAccount = (Account)Activator.CreateInstance(accountType, accountOwner, accountSum, bonusScore);
